...
## Slide 1 — Portada: "El mito de la productividad tóxica"

_(Sin notas de speaker.)_

---

## Slide 2 — Viernes 15:30

Viernes, 15:30 de la tarde, ya estaba contestando los últimos mensajes de Slack. Después de una semana dura de trabajo, donde no paré de tener reuniones, de desbloquear a muchos equipos, de picar mucho código, estaba agotadísimo, pero la verdad que estaba muy contento.
...
## Slide 6 — Cubo (cuestión de perspectiva)
...
## Slide 7 — + Productividad (señales falsas)
...
## Slide 9 — Cita recurrente: "Productividad no es hacer más"

> Productividad no es hacer más. Es generar el mayor impacto con el menor mantenimiento.
...
## Slide 13 — Correr detrás de métricas
...
## Slide 14 — Delhi, India (historia de las cobras)
...
Y todo iba relativamente bien hasta que empezó a ir relativamente mal, al principio los números eran espectaculares, las gráficas bajaban, las métricas están en verde. La gente mataba cobras y cobraba su guita.
...
## Slide 16 — Cita: Charles Goodhart

> When a metric becomes a target, it ceases to be a good measure. — Charles Goodhart
...
¿A quién no le pasó que un amigo empezó a meter tests que en realidad no testean nada, o que es inútil, pero como sube la cobertura se le deja por ahí?

O que una tarea se divide en 5 pull requests porque eso hace que mejore tu métrica de PRs por semana.

---

## Slide 17 — Activo & Pasivo financiero
...
El activo y el pasivo, el activo puede ser no sé una casa que tenés en alquiler y que te da dinerito. El pasivo es algo que te saca dinero, como no sé la hipoteca de esa casa, los gastos de mantenimiento.
...
## Slide 18 — El código es un ACTIVO
...
## Slide 19 — El código es un PASIVO
...
## Slide 20 — La paradoja de Jevons
...
## Slide 21 — La paradoja de Claude / Copilot
