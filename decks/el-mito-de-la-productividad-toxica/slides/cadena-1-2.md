...
variant: default
items:
  - { glyph: '<img src="/talks/decks/el-mito-de-la-productividad-toxica/assets/icon-impact-2.svg" alt="">' }
  - { glyph: '<img src="/talks/decks/el-mito-de-la-productividad-toxica/assets/icon-avoid.svg" alt="">' }
notes: |
