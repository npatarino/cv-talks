...
label: Scientíficos Jurassic Park
variant: testimonial
fields:
  initials: { content: '<img src="/talks/decks/el-mito-de-la-productividad-toxica/assets/icon-jurassic-park.png" alt="" class="title-icon">', meta: Avatar_Initials }
  quote: { content: 'Tus científicos estaban tan preocupados por saber si podían, que no se detuvieron a pensar si debían.', meta: Quote_Text }
  who: { content: Dr. Ian Malcolm, meta: Speaker_Name }
