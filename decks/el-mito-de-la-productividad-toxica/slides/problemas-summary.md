...
template: icon
recipe: critical
label: Problemas - Summary
variant: default
items:
  - { glyph: '<img src="/talks/decks/el-mito-de-la-productividad-toxica/assets/icon-target-2.svg" alt="">' }
  - { glyph: '<img src="/talks/decks/el-mito-de-la-productividad-toxica/assets/icon-liability-2.svg" alt="">' }
  - { glyph: '<img src="/talks/decks/el-mito-de-la-productividad-toxica/assets/cape-blue.png" alt="">' }
notes: |
